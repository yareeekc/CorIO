...
mkdir -p /corio/
cp -r ./* /corio/
printf "/corio/backend.sh &\ncage -- chromium --kiosk --user-data-dir="/tmp/chrome_dev_session" --allow-file-access-from-files /corio/index.html --disable-web-security file:///corio/index.html\n" > /usr/bin/corio
printf "[WebService]\nListenAddress = 127.0.0.1\nAllowUnencrypted = true\nAllowOrigins = null file://\nFrameAncestors = null file://\n" > /etc/cockpit/cockpit.conf
